        ...
        <div className="p-6 space-y-4 max-h-[85vh] overflow-y-auto">
          ...
          <div className="text-center space-y-1">
            <h4 className="text-lg font-bold text-stone-900">
              {authView === 'device_chooser' 
                ? (isSignUp ? 'Choose Account to Sign Up' : 'Choose an Account')
                : (isSignUp ? 'Create Your Citizen Account' : 'Welcome Back')}
            </h4>
            <p className="text-xs text-stone-500">
              {authView === 'device_chooser'
                ? 'Select an existing account from this device or continue with Google'
                : (isSignUp 
                    ? 'Enter your citizen credentials to register for verified schemes'
          ...
          {/* ========================================================= */}
          {/* VIEW 1: DEVICE ACCOUNT CHOOSER (Multiple Accounts on Device) */}
          {/* ========================================================= */}
          {authView === 'device_chooser' ? (
            ...
            /* ========================================================= */
            /* VIEW 2: MANUAL CREDENTIALS FORM (Email & Password) */
            /* ========================================================= */
            <div className="space-y-3.5">
              
              {/* Back to Device Accounts button */}
              <button
                type="button"
              ...
              >
                ...
                <span>Choose an account on this device ({deviceAccounts.length})</span>
              </button>
              ...
              <div className="relative flex py-1 items-center">
                ...
                <span className="shrink mx-3 text-[11px] text-stone-400 font-medium">or enter details</span>
                <div className="grow border-t border-stone-200"></div>
              </div>
          ...
          <div className="pt-2 border-t border-stone-200/80">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[10px] text-stone-400 font-medium">1-Click Test Login</span>
            </div>
          ...
          <div className="flex items-center justify-center gap-1.5 text-[11px] text-stone-400 pt-1">
            ...
            <span>Secure Firebase Authentication & Multiple Account Support</span>
          </div>
