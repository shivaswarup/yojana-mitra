...
export const STATE_DISTRICT_MAP: Record<string, string[]> = {
  ...
  'Chhattisgarh': [
    ...
    'Sarangarh-Bilaigarh', 'Sukma', 'Surajpur', 'Surguja (Ambikapur)'
  ],
  'Goa': [
    'North Goa', 'South Goa'
  ],
  ...
  'Madhya Pradesh': [
    ...
    'Morena', 'Narsinghpur', 'Neemuch', 'Niwari', 'Narmadapuram (Hoshangabad)', 
  ...
  'Sikkim': [
    'Gangtok', 'Mangan', 'Namchi', 'Geyzing', 'Pakyong', 'Soreng'
  ],
  'Tamil Nadu': [
